...
function ageIndays() {
   ...
   var rohan=(2020-birthyear)*365;
   var h1=document.createElement('h1');
   var textAnswer=document.createTextNode('You are '+ rohan +' days old.');
...
function rpsFrontEnd(humanImageChoice, botImageChoice, finalMessage){
    var imagesDatabase={
      ...
      //Lets remove all the images
       ...
       humanDiv.innerHTML = "<img src='" + imagesDatabase[humanImageChoice] + "' width=150 height=150 style='box-shadow: 0px 10px 50px rgb(204, 114, 200)'>"
...
const drawSound = new Audio('./static/sounds/hmm.mp3')
...
async function dealerLogic(){
    if(blackjackGame['hitFirst']===true){
